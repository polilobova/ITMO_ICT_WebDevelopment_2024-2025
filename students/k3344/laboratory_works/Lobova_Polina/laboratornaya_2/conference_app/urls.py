...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(next_page='index'), name='login'),
    ...
    path('presentations/delete/<int:presentation_id>/', views.delete_presentation, name='delete_presentation'),
    path('conferences/<int:conference_id>/add_review/', views.add_review, name='add_review'),
